...
def main():
    ...
    file_path = "C:\\Users\\the-r\\Desktop\\Llama\\backend\\Essay.pdf"
    text = bot.load_document(file_path)

    print("[✓] Document Loaded.")

    # Create vector DB
    bot.create_vector_db(text)
    print("[✓] Vector DB created.")

    # Ask a question
    question = "What is the main objective of the company?"
    answer, confidence, similarity = bot.answer_question(question)

    print("\n📌 Question:", question)
    print("💬 Answer:", answer)
    print("🔍 Retrieval Confidence Score:", round(confidence, 2))
    print("🧠 Semantic Similarity Score:", round(similarity, 4))
